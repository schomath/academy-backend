            ...
            modules: [
              { id: 'plcs-click-comm',
                ...
                blocks: [
                  ...
                  {id: 'b10', type: 'markdown', content: '## Let\'s Send some Data!\n\nTo actually send and recieve data, the **client PLC** will utilize the **\`Recieve\`** and **\`Send\`** instructions found in the **Instruction List**.\n - The **\`Recieve\`** instruction is used to receive data from the server PLC. In other words, we\'d like **this** PLC to get data from the other PLC.\n - The **\`Send\`** instruction is used to send data to the server PLC.'},
                ]
              },
              { id: 'plcs-click-misc',
                title: 'CLICK PLC Documentation',
